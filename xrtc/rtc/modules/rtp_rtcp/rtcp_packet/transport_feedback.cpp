...
// 至少需要包含一个packet chunk, 2字节
            ...
            constexpr int64_t kBaseScaleFactor =
            TransportFeedback::kDeltaScaleFactor * 256;
...
//    +-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+
        ...
        webrtc::TimeDelta TransportFeedback::GetBaseDelta(
                int64_t prev_timestamp_us) const
    {
